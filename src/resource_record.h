...
int parseRRCNAME(char* buf, size_t buf_len, char* base_addr, uint16_t rd_len, struct RR_CNAME* cname);
...
int parseRRMB(char* buf, size_t buf_len, char* base_addr, uint16_t rd_len, struct RR_MB* mb);

typedef struct RR_MD {
    char madname[256];
} RR_MD;

int parseRRMD(char* buf, size_t buf_len, char* base_addr, uint16_t rd_len, struct RR_MD* md);

typedef struct RR_MF {
    char madname[256];
} RR_MF;

int parseRRMF(char* buf, size_t buf_len, char* base_addr, uint16_t rd_len, struct RR_MF* mf);

typedef struct RR_MG {
    char mgmname[256];
} RR_MG;

int parseRRMG(char* buf, size_t buf_len, char* base_addr, uint16_t rd_len, struct RR_MG* mg);
...
int parseRRMR(char* buf, size_t buf_len, char* base_addr, uint16_t rd_len, struct RR_MR* mr);
...
int parseRRNS(char* buf, size_t buf_len, char* base_addr, uint16_t rd_len, struct RR_NS* ns);
